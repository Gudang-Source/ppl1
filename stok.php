          ...
          <div class="col s10">
            ...
            <!-- Edit-Modal-->
              <div id="edit-modal" class="modal modal-fixed-footer">
                <div class="modal-content">
                  ...
                  <div class="row">
                    <form class="col s12">
                      ...
                      <div class="row">
                        <div class="input-field col s6">
                          <input id="jumlah-atk" type="text" class="validate">
                          <label class="edit-label" for="jumlah">Jumlah</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s6">
                ...
                <div class="modal-footer">
                  <a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat">Perbarui</a>
                </div>
              </div>
            <!-- Delete-Modal-->
